...
Meet the **BlockchainRPG Dashboard** — a fast, modern way to manage your characters and play, right in your web browser on desktop or mobile.
...
V6.0.0 is the foundation for everything we're building next. Hop into the **Dashboard**, gather a party, and take down a boss together.
