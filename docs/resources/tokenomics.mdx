...
GOLD is generated at a constant rate of 0.00000013 GOLD per second.
0.00000012 GOLD generated is stored in a GOLD "pool" and used for Hunt rewards.
...
0.00000001 GOLD is stored in a Development Pool, which is used to support ongoing development, provide liquidity, and fund rewards.
